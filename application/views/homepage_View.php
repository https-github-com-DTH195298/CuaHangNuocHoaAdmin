...
<link rel="stylesheet" href="<?php echo base_url(''); ?>/dist/css/sb-admin-2.min.css">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Linh Phan</span>
                                <img class="img-profile rounded-circle"
                                    src="https://raw.githubusercontent.com/thumlabero1/nhatlinh/main/avatar.jpg" alt="" width="32" height="32">
                            </a>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 100%;">
    ...
    <div class="dropdown">
      <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
        <img src="https://raw.githubusercontent.com/thumlabero1/nhatlinh/main/avatar.jpg" alt="" width="32" height="32" class="rounded-circle me-2">
        <strong>mdo</strong>
      </a>
...
<script src="<?php echo base_url(''); ?>/dist/css/bootstrap.js"></script>
</body>
</html>
